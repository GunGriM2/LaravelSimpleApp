...
@section('content')
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary bg-primary-gradient">
        <a class="navbar-brand d-flex align-items-center fw-500" href="users.blade.php">
            <img alt="logo"
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <div class="row">
            <div class="col-xl-12">
                <a class="btn btn-success" href="create_user.blade.php">Добавить</a>
                        ...
                        <div class="d-flex flex-row align-items-center">
                            ...
                            <div class="info-card-text flex-1">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="edit.blade.php">
                                        <i class="fa fa-edit"></i>
                                        Редактировать</a>
                                    <a class="dropdown-item" href="security.blade.php">
                                        <i class="fa fa-lock"></i>
                                        Безопасность</a>
                                    <a class="dropdown-item" href="status.blade.php">
                                        <i class="fa fa-sun"></i>
                                        Установить статус</a>
                                    <a class="dropdown-item" href="media.blade.php">
